...
impl MldsaVariant {
    fn wasm_filename(&self) -> &'static str {
        match self {
            MldsaVariant::MLDSA2 => "ml-dsa2.wasm",
            MldsaVariant::MLDSA3 => "ml-dsa3.wasm",
            MldsaVariant::MLDSA5 => "ml-dsa5.wasm",
            MldsaVariant::MLDSA2AES => "ml-dsa2-aes.wasm",
            MldsaVariant::MLDSA3AES => "ml-dsa3-aes.wasm",
            MldsaVariant::MLDSA5AES => "ml-dsa5-aes.wasm",
        }
    }
...
impl MldsaWasmLoader {
    ...
    pub async fn load_module(&mut self) -> Result<(), JsValue> {
        ...
        let base_path = "./rustpqc/ml-dsa/wasm-kat/";
