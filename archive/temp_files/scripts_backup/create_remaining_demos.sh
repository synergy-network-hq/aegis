...
echo "🚀 Creating remaining demo application files..."

# List of remaining non-WASM demos
REMAINING_DEMOS=(
    "iot-security"
    "financial-security"
...
<head>
    ...
    <title>${demo//-/ } - Aegis PQC Demo</title>
...
<body>
    <div class="demo-container">
        <div class="demo-content">
            ...
            <h1 class="demo-title">${demo//-/ } Demo</h1>
            <p class="demo-description">
                This demo application is currently under development and will showcase
                Aegis's post-quantum cryptography capabilities for ${demo//-/ } use cases.
            </p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>${demo//-/ } - Aegis WASM Demo</title>
    <link rel="stylesheet" href="../portal/portal.css">
    <style>
        .demo-container {
            display: flex;
...
<body>
    <div class="demo-container">
        <div class="demo-content">
            <div class="demo-icon">🌐</div>
            <h1 class="demo-title">${demo//-/ } WASM Demo</h1>
            <p class="demo-description">
